...
UCLASS(Abstract)
class UCKCOREPLUGIN_API UInputBehaviorConfig : public UActorComponent
{
	GENERATED_BODY()
...
UCLASS( Abstract )
class UCKCOREPLUGIN_API UInputHandlersContainer : public UInputBehaviorConfig
{
	GENERATED_BODY()
public:
...
UCLASS(Abstract)
class UCKCOREPLUGIN_API UInputContainer : public UInputHandlersContainer
{
	GENERATED_BODY()
public:
	UPROPERTY(BlueprintReadWrite, Category = "Default")
...
class UCKCOREPLUGIN_API UInputController_ACC : public UInputContainer
{
	GENERATED_BODY()
public:
